  ...
  productsData = [
    {
      image: "1.png",
      title: "Лучшие друзья",
      text: "Печенье, с которого все началось!" +
        "Наше фирменное печенье с шоколадной крошкой и грецкими орехами хрустящее снаружи с достаточно толстой и липкой серединкой.",
      price: 20,
      basePrice: 20,
      weight: "2 шт./ 200 гр.",
    },
